        ...
        <AuthenticatedLayout user={auth.user} >
            ...
            <div className="p-4 md:p-8">
                <div className="flex flex-col bg-indigo-600 dark:bg-indigo-400 rounded-md">
                    ...
                    {isClicked && <Edit groupName={groupName} groupId={groupId} initialGroupStocks={groupStocks} initialUserStocks={userStocks} isClicked={isClicked} setIsClicked={setIsClicked} /> }
                </div>
            </div>
        </AuthenticatedLayout>
    )
